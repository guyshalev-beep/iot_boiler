...
class NotificationManager{
  ...
  static notify(String title, String body){
    notificationManager._showNotification(title,body);
  }
  ...
  static notificationInitState(){
    notificationManager._isAndroidPermissionGranted();
    notificationManager._requestPermissions();
